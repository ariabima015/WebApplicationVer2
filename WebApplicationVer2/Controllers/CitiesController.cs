...
namespace WebApplicationVer2.Controllers
{
    public class CitiesController : Controller
    {
        ...
        {
            var databaseContext = _context.Cities.Include(c => c.Group);
        ...
        public async Task<IActionResult> Create([Bind("CityId,Name,GroupId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,Name,GroupId")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
